        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-4 col-md-6 col-12 order-2 mb-2 wow fadeInUp delay01">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="chinh-sach.php?id=2" class="smooth">Chính sách vận chuyển</a></li>
                    <li><a href="chinh-sach.php?id=3" class="smooth">Chính sách đổi trả</a></li>
                    <li><a href="chinh-sach.php?id=4" class="smooth">Chính sách bảo mật</a></li>
            ...
            <div class="col-lg-4 col-md-6 col-12 order-3 mb-2 wow fadeInUp delay02">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="gioi-thieu.php?id=2" class="smooth">Liên hệ</a></li>
                    <li><a href="gioi-thieu.php?id=3" class="smooth">Tin tức</a></li>
                    <li><a href="gioi-thieu.php?id=4" class="smooth">Hướng dẫn mua hàng</a></li>
                    <li><a href="gioi-thieu.php?id=5" class="smooth">Câu hỏi thường gặp</a></li>
                </ul>
            </div>
        </div>
