...
<main style="margin-top: 150px;">
    <section class="container py-4 mt-20">
        <h2 class="main-title text-center mb-5 text-uppercase wow fadeInUp delay01">ĐỒNG HỒ CÓ SẴN</h2>
        <p class="text-center mb-5">Những sản phẩm đồng hồ cao cấp đang có sẵn tại cửa hàng, sẵn sàng giao ngay cho quý khách.</p>
    </section>
    ...
    <section class="h_pro_cate py-5 bgfixed rela lazy" data-src="images/anh-nen-richard-mille.jpg">
        <div class="d_box_slider rela wow fadeInDown delay03">
            <div class="container">
                <div class="row">
                    <?php if (!empty($inStockProducts)): foreach ($inStockProducts as $product): ?>
                    ...
                    <?php endforeach; else: ?>
                        <div class="col-12 text-center">
                            <div class="alert alert-info">
                                Hiện tại không có sản phẩm nào trong kho. Vui lòng quay lại sau.
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
